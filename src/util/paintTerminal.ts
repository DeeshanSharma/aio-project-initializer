...
const display = {
  ...
  strings: [
    `${figlet.textSync('aio-project-initializer', 'Larry 3D')}`,
    '\nThis package is developed by Deeshan Sharma.',
    '\nSee the source code here https://github.com/DeeshanSharma/aio-project-initializer. Give it a star if you like it.\n',
  ],
};
